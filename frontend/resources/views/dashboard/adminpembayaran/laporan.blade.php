        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 items-center">
            ...
            <table class="border border-gray-300 mx-auto w-full mb-12">
                <tr class="bg-black text-white ">
                    ...
                    <th id="font" class="border border-gray-300 text-left px-4 py-2">Total Pendapatan</th>
                    <th id="font" class="border border-gray-300 text-left px-4 py-2">Semester</th>
                </tr>
                <?php
                $data = [
                    ['no' => 1, 'pendapatan' => 550000000, 'semester' => 'Semester Ganjil 2024'],
                    ['no' => 2, 'pendapatan' => 680000000, 'semester' => 'Semester Genap 2024'],
                ];
                foreach ($data as $row) {
                    echo "<tr>
