                        ...
                        @foreach ($teachers['data'] as $teacher )
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 flex gap-2">
                                    <p data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" id="edit-teacher" class="font-medium text-blue-600 dark:text-blue-500 hover:underline cursor-pointer {{ $teacher['id'] }} edit-teahcer">Edit</p>
                                    <div class="w-0.5 h-4 bg-gray-200"></div>
                                    <p id="delete-teacher" class="font-medium text-red-600 dark:text-red-500 hover:underline cursor-pointer {{ $teacher['id'] }} delete-teacher">Delete</p>
                                </td>
                            </tr>
                        @endforeach
