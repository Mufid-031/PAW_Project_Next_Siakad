    ...
    <x-layout>
        <main class="ml-20 mr-20 mt-5">
            <div class="bg-white rounded-lg shadow-lg">
                ...
                <div class="p-6">
                    <!-- Add Button -->
                    <button onclick="location.href='/student/krs/add'" class="mb-6 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2">
