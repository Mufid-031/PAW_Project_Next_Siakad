            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg shadow">
                        ...
                        <p class="text-gray-600"><strong>Status Ikatan Kerja:</strong> Dosen Tetap</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-lg w-1/3">
                ...
                <form action="#" method="POST" class="p-4 grid grid-cols-2 gap-2" >
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nama" name="nama" value="John Doe" class="w-full border-gray-300 rounded-lg shadow-sm">
                    </div>
                    <!-- Jenis Kelamin -->
                    <div class="mb-4">
                    ...
                    <!-- Pendidikan Terakhir -->
                    <div class="mb-4">
                        <label for="pendidikan_terakhir" class="block text-gray-700 font-medium">Pendidikan Terakhir:</label>
                        <input type="text" id="pendidikan_terakhir" name="pendidikan_terakhir" value="S2" class="w-full border-gray-300 rounded-lg shadow-sm">
                    </div>
                    <!-- Status Aktivitas -->
                    <div class="mb-4">
                        <label for="status_aktivitas" class="block text-gray-700 font-medium">Status Aktivitas:</label>
                        <input type="text" id="status_aktivitas" name="status_aktivitas" value="Aktif" class="w-full border-gray-300 rounded-lg shadow-sm">
                    </div>
                    <!-- Perguruan Tinggi -->
                    <div class="mb-4">
                        <label for="perguruan_tinggi" class="block text-gray-700 font-medium">Perguruan Tinggi:</label>
                        <input type="text" id="perguruan_tinggi" name="perguruan_tinggi" value="Universitas Trunojoyo" class="w-full border-gray-300 rounded-lg shadow-sm">
                    </div>
                    <!-- Program Studi -->
                    <div class="mb-4">
                        <label for="program_studi" class="block text-gray-700 font-medium">Program Studi:</label>
                        <input type="text" id="program_studi" name="program_studi" value="Teknik Informatika" class="w-full border-gray-300 rounded-lg shadow-sm">
                    </div>
                    <!-- Jabatan Fungsional -->
                    <div class="mb-4">
                        <label for="jabatan_fungsional" class="block text-gray-700 font-medium">Jabatan Fungsional:</label>
                        <input type="text" id="jabatan_fungsional" name="jabatan_fungsional" value="Lektor" class="w-full border-gray-300 rounded-lg shadow-sm">
                    </div>
                    <!-- Status Ikatan Kerja -->
                    <div class="mb-4">
                        <label for="status_ikatan_kerja" class="block text-gray-700 font-medium">Status Ikatan Kerja:</label>
                        <input type="text" id="status_ikatan_kerja" name="status_ikatan_kerja" value="Dosen Tetap" class="w-full border-gray-300 rounded-lg shadow-sm">
                    </div>
                    <div></div>
                    <!-- Tombol Simpan -->
                    <div class="flex justify-end">
                        <button type="button" onclick="toggleModal()" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded-lg mr-2">
                            Batal
                        </button>
