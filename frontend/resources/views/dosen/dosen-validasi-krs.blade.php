                            ...
                            <table class="min-w-full border-collapse border border-gray-200">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-700 border-b">Status KRS</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 border-b">12345678</td>
                                        <td class="px-6 py-4 border-b">John Doe</td>
                                        <td class="px-6 py-4 border-b">Teknik Informatika</td>
                                        <td class="px-6 py-4 border-b">6</td>
                                    ...
                                    <!-- Mahasiswa 2 -->
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 border-b">87654321</td>
                                        <td class="px-6 py-4 border-b">Jane Smith</td>
                                        <td class="px-6 py-4 border-b">Sistem Informasi</td>
                                        <td class="px-6 py-4 border-b">4</td>
                                        <td class="px-6 py-4 border-b">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Menunggu Validasi</span>
                                        </td>
                                        <td class="px-6 py-4 border-b">
                                    ...
                                    <!-- Mahasiswa 3 -->
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 border-b">13579246</td>
                                        <td class="px-6 py-4 border-b">Michael Brown</td>
                                        <td class="px-6 py-4 border-b">Manajemen Informatika</td>
                                        <td class="px-6 py-4 border-b">8</td>
                                        <td class="px-6 py-4 border-b">
                                    ...
                                    <!-- Mahasiswa 4 -->
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 border-b">24681357</td>
                                        <td class="px-6 py-4 border-b">Emily Davis</td>
                                        <td class="px-6 py-4 border-b">Teknik Komputer</td>
