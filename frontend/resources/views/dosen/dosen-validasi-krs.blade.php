                        ...
                        <table class="w-full table-auto border-collapse border border-gray-300">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 border-b">Program
                                        Studi</th>
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 border-b">Semester
                                    </th>
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 border-b">Status
                                        KRS</th>
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 border-b">
                                        <button
                                            class="px-4 py-2 rounded-md bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700">Validasi</button>
                                        <a
                                            class="px-4 py-2 rounded-md bg-green-600 text-white text-sm font-semibold hover:bg-green-700">Detail</a>
                                    </td>
                                </tr>
                                <!-- Mahasiswa 2 -->
                                <tr class="hover:bg-gray-50">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-2 border-b">
                                        <span
                                            class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Tervalidasi</span>
                                    </td>
                                    <td class="px-6 py-4 border-b">
                                        <button
                                            class="px-4 py-2 rounded-md bg-gray-500 text-white text-sm font-semibold cursor-not-allowed">Sudah
                                            Validasi</button>
                                        <a
                                            class="px-4 py-2 rounded-md bg-green-600 text-white text-sm font-semibold hover:bg-green-700">Detail</a>
                                    </td>
