        ...
        <main class="ml-20 mr-20">
                <div class="max-w-6xl mx-auto p-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <a href="{{ route('dosen.tambah-materi') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 active:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200 disabled:opacity-25 transition">Tambah Materi</a>
